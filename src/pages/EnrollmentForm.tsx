        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground">
              Preencha os dados abaixo para se inscrever nos nossos cursos ou
              explicações
            </p>
          </div>
            ...
            {step === 1 && (
              <Card>
                ...
                <CardContent className="space-y-6">
                  <RadioGroup
                    value={formData.type}
                    onValueChange={(value: "curso" | "explicacao") =>
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="explicacao" className="font-medium">
                        Explicação (Ensino Médio Técnico)
                      </Label>
                    </div>
                  </RadioGroup>
                ...
                <CardContent>
                  <div className="space-y-2">
                    <Label htmlFor="idDocument">
                      Envie o seu Bilhete de Identidade em PDF *
                    </Label>
            ...
            <div className="flex justify-between">
              ...
              {step < 4 ? (
                <Button
                  ...
                  disabled={
                    (step === 1 &&
                      (!formData.type || !formData.selectedCourse)) ||
                    (step === 2 &&
                      (!formData.fullName ||
                        !formData.biNumber ||
                        !formData.birthDate ||

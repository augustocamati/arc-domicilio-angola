      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Pronto para começar a sua jornada de aprendizagem ou desenvolver o
            seu projecto? Estamos aqui para ajudar e responder a todas as suas
            questões.
          </p>
        </div>
            ...
            <Card className="border-0 bg-gradient-to-br from-primary/5 to-accent/5">
              ...
              <CardContent className="space-y-4">
                <Button
                  ...
                  onClick={() =>
                    window.open(
                      `mailto:augustocamati21@gmail.com?subject=Interesse em Curso&body=Olá, tenho interesse em saber mais sobre os cursos da Academia ARC.`
                    )
                  }
                >
                ...
                <Button
                  ...
                  onClick={() =>
                    window.open(
                      `https://wa.me/${APP_CONFIG.academy.whatsapp}?text=Olá, tenho interesse em saber mais sobre a Academia ARC.`
                    )
                  }
                >
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <p className="text-xs text-muted-foreground text-center">
                    Ao enviar esta mensagem, concorda com o processamento dos
                    seus dados para fins de contacto. Os seus dados são tratados
            ...
            {[
              {
                ...
                answer:
                  "Levamos todo o material necessário até sua casa e adaptamos o conteúdo ao seu ritmo de aprendizagem.",
              },
              {
                question: "Qual é a duração típica dos cursos?",
                answer:
                  "Varia entre 3-10 semanas dependendo do curso e da disponibilidade do aluno.",
              },
              {
                question: "Fornecem certificado de conclusão?",
                answer:
                  "Sim, todos os nossos cursos incluem certificado de conclusão reconhecido.",
              },
              {
                question: "Fazem orçamentos gratuitos?",
                answer:
                  "Sim, oferecemos consultoria e orçamentos gratuitos para todos os serviços.",
              },
              {
                question: "Atendem fora de Luanda?",
                answer:
                  "Actualmente focamos em Luanda, mas avaliamos pedidos de outras províncias.",
              },
              {
                question: "O material está incluído no preço?",
                answer:
                  "Sim, todo o material didáctico e equipamentos necessários estão incluídos.",
              },
            ].map((faq, index) => (
